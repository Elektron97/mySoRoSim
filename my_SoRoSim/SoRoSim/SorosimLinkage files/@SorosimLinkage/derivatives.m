...
% function [dqdt, u]=derivatives(Tr,t,qqd,uqt)
...
%         u = CustomActuatorStrength(Tr,q.*Tr.q_scale,g_act,J_act,t,qd.*Tr.q_scale,eta_act,Jd_act,M_act,C_act,F_act,Bq_act);
        u = my_CustomActuatorStrength(Tr,q.*Tr.q_scale,g_act,J_act,t,qd.*Tr.q_scale,eta_act,Jd_act,M_act,C_act,F_act,Bq_act);    
    end
